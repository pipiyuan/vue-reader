<template>
    <div class="discover">
        <header-top signin-up="discover"><span slot="top-title" class="top-title">发现</span></header-top>
...
export default {
    ...
    data () {
        return {
            geohash: '29.487597,106.642932',
            searchValue: '', // 搜索内容
            restaurantList: [], // 搜索返回的结果
            imgBaseUrl: 'http://images.cangdu.org/', // 图片域名地址
    ...
    .discover{
        ...
        .search_form{
            ...
            .search_input{
                ...
                @include size-color(0.65rem, #333);
            ...
            .search_submit{
                ...
                margin-left: .2rem;
                @include size-color(0.65rem, #fff);
                border-radius: 0.125rem;
